...
@objc open class PlayerView: UIView {
    private let notifier = Notifier.instance("PlayerViewController")
    ...
    // MARK: public Functions333
    
    open func play() {
        rate = 1
        player?.play()
        try? AVAudioSession.sharedInstance().setCategory(.multiRoute, mode: .voiceChat)
...
extension PlayerView {
    ...
    var currentItemStatus: PVItemStatus? {
