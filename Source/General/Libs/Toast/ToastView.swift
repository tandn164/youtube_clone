...
open class ToastView: UIView {
    ...
    private let textLabel: UILabel = {
        ...
        self.font = {
            switch UIDevice.current.userInterfaceIdiom {
            case .unspecified: return .systemFont(ofSize: 14)
            case .phone: return .systemFont(ofSize: 14)
            case .pad: return .systemFont(ofSize: 18)
            case .tv: return .systemFont(ofSize: 22)
    ...
    override open func layoutSubviews() {
        ...
        x = (width - backgroundViewSize.width) * 0.5//        y = height - (backgroundViewSize.height + y)
        // Thanh Tran: center vertial all toast
